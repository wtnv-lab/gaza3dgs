...
const scenes = [
    {
        ...
        descriptionJa: "アル・シファ病院の中庭で治療を受ける避難民のパレスチナ人たちを記録した3Dモデル。イスラエル軍による度重なる襲撃の後、病院の主要病棟は深刻な損傷を受け、あるいは破壊され、患者と医療スタッフは屋外空間での治療を余儀なくされた。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "アル・シファ病院の中庭にある駐車区域と、破壊された車両。施設全体に及ぶ甚大な被害は、ガザ最大の病院を最終的に機能停止へ追い込んだ攻撃の激しさを物語っている。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "アル・シファ病院の破壊された正面入口と内部の記録。医療施設を廃墟に変えた激しい戦闘と爆撃の後の状況を示している。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "アル・シファ病院で、複数の未熟児が保温とケアのために一つのベッドを共有する様子。軍事作戦による停電と損傷で専用の保育器が使えなくなり、医療スタッフは命をつなぐために応急的な対応を迫られた。",
        type: "iframe",
    ...
    },
    {
        ...
        descriptionJa: "現在は空になり機能していない、アル・シファ病院の新生児集中治療室（NICU）。かつて救命機器で満たされていたこの部屋は、ガザ最大の病院における医療体制の崩壊を鋭く物語っている。",
        type: "iframe",
    ...
    },
    {
        ...
        descriptionJa: "ブレイジ難民キャンプで破壊された国連（UN）車両。UNRWAの元映像は支援車列への攻撃後の状況を示しており、ガザ地区で人道支援に携わる人々が置かれた危険な環境を浮き彫りにしている。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "ハンユニス市に広がる破壊の記録。UNRWAが捉えたこの場面は、ガザ地区南部で続いたイスラエル軍の作戦の後、住宅や都市インフラに及んだ甚大な被害を伝えている。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "ハンユニスの荒廃を別の視点から捉えた記録。破壊の規模は非常に大きく、市内の広い地域が居住不能となり、将来に向けた人道上・復興上の大きな課題を生み出している。",
        type: "spz",
    ...
    },
    {
        ...
        descriptionJa: "日本政府の開発支援で建設された、ハンユニスの高架橋。橋に掲げられた日本語の標識には支援への感謝が記されている。このインフラは地域交通の改善を目的とし、近年の紛争以前には友好の象徴として存在していた。",
        type: "iframe",
